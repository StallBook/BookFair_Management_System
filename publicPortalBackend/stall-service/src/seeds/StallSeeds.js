...
const stalls = [
  ...
  // Medium stalls
  { name: "D", size: "medium", dimensions: { width: 3, length: 3 }, map: { x: 0, y: 3, w: 3, h: 3 } },
  { name: "E", size: "medium", dimensions: { width: 3, length: 3 }, map: { x: 4, y: 3, w: 3, h: 3 } },
  { name: "F", size: "medium", dimensions: { width: 3, length: 3 }, map: { x: 8, y: 3, w: 3, h: 3 } },

  // Large stalls
  { name: "G", size: "large", dimensions: { width: 4, length: 4 }, map: { x: 0, y: 7, w: 4, h: 4 } },
  { name: "H", size: "large", dimensions: { width: 4, length: 4 }, map: { x: 5, y: 7, w: 4, h: 4 } },
];
